"""Create politician related models

Revision ID: 0006_62027a38d027
Revises: 0005_c024c5eacb27
Create Date: 2023-10-28 01:43:59.486418
...
revision: str = "0006_62027a38d027"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=10), nullable=False, comment="의원 이름"),
        sa.Column(
            "profile_url", sa.String(length=256), nullable=True, comment="프로필 주소"
        ),
        sa.Column(
            "political_party", sa.String(length=30), nullable=False, comment="소속 정당"
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(length=30), nullable=False, comment="위원회 명칭"),
        sa.Column("created_at", sa.DateTime(), nullable=False, default=datetime.now()),
        sa.Column(
            "updated_at",
            sa.DateTime(),
