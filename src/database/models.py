...
class Politician(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, index=True)
    name = Column(String(256), nullable=False, comment="의원 이름")
    profile_url = Column(String(256), nullable=True, comment="프로필 주소")
    political_party = Column(String(256), nullable=False, comment="소속 정당")
...
class Committee(Base):
    ...
    name = Column(String(256), nullable=False, comment="위원회 명칭")
    created_at = Column(DateTime, default=datetime.now, nullable=False)
    updated_at = Column(
        DateTime, default=datetime.now, onupdate=datetime.now, nullable=False
    )
...
class Constituency(Base):
    ...
    region = Column(String(256), nullable=False, comment="지역구")
    district = Column(String(256), nullable=True, comment="세부 지역구")
    section = Column(String(256), nullable=True, comment="분구")
    created_at = Column(DateTime, default=datetime.now, nullable=False)
    updated_at = Column(
        DateTime, default=datetime.now, onupdate=datetime.now, nullable=False
    )
